...
GPT_SERVER_API_BASE_URL = os.environ.get(
    "GPT_SERVER_API_BASE_URL", "http://localhost:11434/api"
)

if ENV == "prod":
    if GPT_SERVER_API_BASE_URL == "/server/api":
        GPT_SERVER_API_BASE_URL = "http://host.docker.internal:11434/api"
