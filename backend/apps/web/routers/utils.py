...
from config import GPT_SERVER_API_BASE_URL
        ...
        async with session.get(url, headers=headers) as response:
            ...
            with open(file_path, "ab+") as file:
                ...
                if done:
                    ...
                    url = f"{GPT_SERVER_API_BASE_URL}/blobs/sha256:{hashed}"
                    ...
                    if response.ok:
                        ...
                        raise "Could not create blob, Please try again."
            ...
            with open(file_path, "rb") as f:
                ...
                if done:
                    ...
                    if response.ok:
                        ...
                        raise Exception(
                            "Could not create blob, Please try again."
                        )
